...
const page = async () => {  
  const dummyAllSongListArray1 = [...dummyPlaylistArray];
  ...
  return (
    <PagePadding>
      <div className='max-w-full min-h-[600px]'>
        <div className='mt-9'></div>
        <Category />      
        <div className='mt-12'></div>
        <PlayListCarousel 
          palylistArray={[...dummyAllSongListArray1]} 
          Thumbnail={
        ...
        <PlayListCarousel
          palylistArray={[...dummyPlaylistArray2]}
          title="케이시 - Full Bloom"
          subTitle="새로운 앨범"
        />
        <div className="mt-20"></div>
        <PlayListCarousel
          palylistArray={[...dummyPlaylistArray3]}
          title="커뮤니티 제공"
        />
        <div className="mt-20"></div>
        <PlayListCarousel
          palylistArray={[...dummyPlaylistArray4]}
          title="커버 및 리믹스"
        />
      </div>
    </PagePadding>
